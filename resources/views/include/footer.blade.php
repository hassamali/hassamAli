...
<footer class="page-footer font-small stylish-color-dark pt-4 mt-4">
      ...
      <div class="container text-center text-md-left">
          <div class="row">
              ...
              <!--First column-->
              <div class="col-md-4">
                  <h5 class="text-uppercase mb-4 mt-3 font-weight-bold">About this blog</h5>
                  <p>This blog is about passionate web developers who wants to learn new technology 
                      packages, services and use it with their daily work.
                  </p>
              </div>
              <!--/.First column-->
      ...
      <div class="footer-copyright py-3 text-center">
          <div class="container-fluid">
              © 2018     Copyright: <a href="https://devhassam.com"> Hassam Ali</a>
